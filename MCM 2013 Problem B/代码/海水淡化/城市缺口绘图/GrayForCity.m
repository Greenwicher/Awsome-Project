...
input = xlsread('citywaterhistorydata.xlsx'); % input = numberofcities*numberofyears
...
%初步的绘图
plotresult(numberofyears, forecastscale, input, G)

%保存数据到waterdemandforecast.xlxs
xlswrite('citywaterforecastdata.xls', G)
